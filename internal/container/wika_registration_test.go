...
func TestContainerRegistersWikaSuggestionComponents(t *testing.T) {
	...
	required := []string{
		...
		"initWikaFreshnessService",
		"handler.NewWikaFreshnessHandler",
		"wikaconflict.NewGormStore",
		"wikaconflict.NewDeterministicCandidateGenerator",
		"wikaconflict.NewService",
		"initWikaConflictWorker",
		"startWikaConflictWorker",
		...
		"initWikaURLRefreshWorker",
		"startWikaURLRefreshWorker",
