...
type WikaEvalRun struct {
	...
	MRR            float64    `json:"mrr" gorm:"type:numeric(8,6);not null;default:0"`
	RecallAt5      float64    `json:"recall_at_5" gorm:"type:numeric(8,6);not null;default:0"`
	NDCGAt5        float64    `json:"ndcg_at_5" gorm:"type:numeric(8,6);not null;default:0"`
