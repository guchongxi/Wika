...
type WikaFreshnessCheckItem struct {
	...
	ResolutionAction string     `json:"resolution_action,omitempty" gorm:"type:varchar(32)"`
	ResolutionNote   string     `json:"resolution_note,omitempty" gorm:"type:text"`
	PreviousStatus   string     `json:"previous_status,omitempty" gorm:"type:varchar(24)"`
